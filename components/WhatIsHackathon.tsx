  ...
  return (
    <div>
      <div className="text-center mt-[6vh] md:mt-32 max-w-6xl mx-auto md:px-12 lg:px-32 lg:pr-[5%]">
        ...
        <div class="text-xl md:text-2xl mt-4"> A <span style="color: #90E0EF;">hackathon</span> is a social event where people get together to code <span style="color: #ADE8F4;">awesome</span> projects in a <span style="color: #CAFOF8;">limited time</span>. Our hackathon will welcome beginners, experts, and everybody in between! </div>
