    ...
    <div>
      <div className="text-center mt-[6vh] md:mt-32 max-w-6xl mx-auto md:px-12 lg:px-32 lg:pr-[5%]">
        ...
        <div className="text-xl md:text-2xl mt-4">
          A <span className="text-blue-400 font-bold">hackathon</span> is a
          social event where people get together to code{" "}
          <span className="text-blue-500 font-bold">awesome</span> projects in
          a <span className="text-blue-600 font-bold">limited time</span>. Our
